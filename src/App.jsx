...
function App() {
  ...
  const handleDrop = (e) => {
    e.preventDefault();
    bilderHinzufuegen({ target: { files: e.dataTransfer.files } });
  };
    ...
    return (
      <div style={{ padding: 20 }}>
        <div id="pdf-content">
          ...
          <p>
            Adresse: {aktuellesProjekt.strasse} {aktuellesProjekt.hausnummer}, {aktuellesProjekt.plz} {aktuellesProjekt.stadt}
          </p>
          <p>
            Bauherr: {aktuellesProjekt.bauherr} | Ansprechpartner: {aktuellesProjekt.ansprechpartner}
          </p>
          <ul>
        ...
        <div
          ...
          style={{ border: "2px dashed gray", padding: 20, margin: "20px 0" }}
        >
        ...
        <button onClick={() => setAktuellesProjekt(null)}>Zurück zur Übersicht</button>
      </div>
    );
  }
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  if (snapshot.exists()) {
                    ...
                    console.warn("Projekt nicht gefunden.");
                  }
                } catch (err) {
                  console.error("Fehler beim Projekt öffnen:", err.message);
                }
              }}
            >
              {p.name}
